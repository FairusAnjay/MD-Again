...
const sections = [
   {
    ...
    rows: [
        ...
        rows: [
          ...
          rows: [
            {title: `💬 ${pmenus} Menfess Balas`, rowId: ".? menbalas", description: "Bisa mengirim pesan ke orang dengan Rahasia"},
          ]},{
...
const listMessage = {
 ...
 let fkon = { key: { fromMe: false, participant: `${m.sender.split`@`[0]}@s.whatsapp.net`, ...(m.chat ? { remoteJid: '16504228206@s.whatsapp.net' } : {}) }, message: { contactMessage: { displayName: `${name}`, vcard: `BEGIN:VCARD\nVERSION:3.0\nN:;a,;;;\nFN:${name}\nitem1.TEL;waid=${m.sender.split('@')[0]}:${m.sender.split('@')[0]}\nitem1.X-ABLabel:Ponsel\nEND:VCARD`}}}
  ...
  "businessOwnerJid": `${m.sender.split`@`[0]}@s.whatsapp.net`
    ...
    let urls = pickRandom(['https://telegra.ph/file/dacfee004f86f482f9082.jpg', 'https://telegra.ph/file/017539f62a581dc5db001.jpg', 'https://telegra.ph/file/48e1fd3fa6dce7bf1242e.jpg''])
            ...
            templateButtons: [
                {
                    urlButton: {
                        displayText: `${namebot}`,
                        url: 'https://github.com/FairusAnjay/'
                    }
                },
                {
                    urlButton: {
